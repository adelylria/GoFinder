...
const (
	...
	SettingsThemeDesc    = "settings.theme.description"
	SettingsConfigDesc   = "settings.config.description"
	SettingsUpdates      = "settings.updates"
	SettingsUpdatesDesc  = "settings.updates.description"
	SettingsApply        = "settings.apply"
	SettingsThemeSaved   = "settings.theme.saved"
	SettingsAutoSaved    = "settings.autostart.saved"
	SettingsHiddenSaved  = "settings.hidden.saved"
	SettingsHotkeysSaved = "settings.hotkeys.saved"
	UpdateCurrent        = "update.current"
	UpdateLatest         = "update.latest"
	UpdateCommit         = "update.commit"
	UpdateBuildDate      = "update.build_date"
	...
	UpdateConfirmTitle   = "update.confirm.title"
	UpdateConfirmMessage = "update.confirm.message"
	UpdateRestarting     = "update.restarting"
	UpdateOpenRelease    = "update.open_release"
